...
#To get sentence vectors using sentence fully
def getSentenceVectors(model, sentence):
    tempDf = []
...
# To get sentence vectors using word vectors
...
formattedData = formattedData[['ChatID','Chat']]

# get sentence vector each sentence:
formattedData['message_vector'] = 'Not Available'
formattedData['role'] = 'role'
formattedData['topic'] = 'topic'

# One way
# index = 0
# for sentence in sentences:
#     sentenceVector = getSentenceVectors(model, sentence)
